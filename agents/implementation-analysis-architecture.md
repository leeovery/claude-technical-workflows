...
6. **Write findings** to `.workflows/{work_unit}/implementation/analysis-architecture-c{cycle-number}.md`
...
Write to `.workflows/{work_unit}/implementation/analysis-architecture-c{cycle-number}.md`:
