...
6. **Write findings** to `.workflows/{work_unit}/implementation/analysis-standards-c{cycle-number}.md`
...
Write to `.workflows/{work_unit}/implementation/analysis-standards-c{cycle-number}.md`:
