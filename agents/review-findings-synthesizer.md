...
7. **Write report** — output to `.workflows/{work_unit}/implementation/review-report-c{cycle}.md`
8. **Write staging file** — if actionable tasks exist, write to `.workflows/{work_unit}/implementation/review-tasks-c{cycle}.md` with `status: pending` for each task
