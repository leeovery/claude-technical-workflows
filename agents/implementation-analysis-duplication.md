...
6. **Write findings** to `.workflows/{work_unit}/implementation/analysis-duplication-c{cycle-number}.md`
...
Write to `.workflows/{work_unit}/implementation/analysis-duplication-c{cycle-number}.md`:
