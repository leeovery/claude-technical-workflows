...
```bash
mkdir -p .workflows/{topic}/review/r{N}
```
...
Full findings are written to `.workflows/{topic}/review/r{N}/qa-task-{index}.md`.
...
1. Read all `.workflows/{topic}/review/r{N}/qa-task-*.md` files
