...
.claude/hooks/workflows/write-session-state.sh \
  ...
  --pipeline "This session is part of the bugfix pipeline. After the plan concludes, return to the continue-bugfix skill and execute Step 7 (Phase Bridge). Load: skills/continue-bugfix/references/phase-bridge.md"
```
...
```
Planning pre-flight for bugfix: {topic}
...
Do not end the session after planning — the bugfix pipeline continues.
