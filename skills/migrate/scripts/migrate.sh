...
OLD_CACHE_LOG=".workflows/.cache/migrations.log"
OLD_CACHE_FILE=".workflows/.cache/migrations"
OLD_STATE_FILE=".workflows/.state/migrations"
...
# Old: ".workflows/discussion/auth.md: 001" → extracts "001"
