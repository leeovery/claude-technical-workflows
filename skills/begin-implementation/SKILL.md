...
description: "Bridge skill for pipelines. Runs pre-flight checks for implementation and invokes the technical-implementation skill. Called by continue-* skills or workflow:start — not directly by users."
...
This skill is a **bridge** — it runs pre-flight checks for implementation and hands off to the processing skill. The topic and work_type have already been determined by the caller.
