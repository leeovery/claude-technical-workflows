...
Scratch file path: `docs/workflow/planning/{topic}/.scratch/phase-{N}.md`
...
7. **Scratch file path**: `docs/workflow/planning/{topic}/.scratch/phase-{N}.md`
...
Delete the scratch file: `rm docs/workflow/planning/{topic}/.scratch/phase-{N}.md`

Remove the `.scratch/` directory if empty.
