...
Plans can be stored in different formats. Each format is a directory of 6 files split by concern (about, authoring, reading, updating, dependencies, frontmatter).
